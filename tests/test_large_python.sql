...
INSERT INTO `test_large_python` VALUES (1,'original small text','original 32 char text here!!!!!!','original 33 char text here!!!!!!!','original yaml config data that should be replaced with a much larger anonymized version',''),(2,'another small value','AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA','BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB','some other config that will be replaced','');
