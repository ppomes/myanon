...
INSERT  IGNORE INTO `table to truncate` VALUES (555),(666);
...
INSERT  IGNORE INTO `tata` VALUES (-1,'pp@mydomain.com');
...
INSERT  IGNORE INTO `test_with_column_names` VALUES (1,1),(1,1);
...
INSERT  IGNORE INTO `the_blobs` VALUES (_binary 'hello',_binary 'hello',_binary 'hello',_binary 'hello'),(_binary 'a',_binary 'b',_binary 'c',_binary 'd');
...
INSERT  IGNORE INTO `toto` VALUES (6128,'cpc','ppomes2','otherval1'),(2,'Ã Ã§Ãª','simon','otherval2'),(464,'cpc','ppomes','otherval3'),(2,'Ã Ã§Ãª','brtvl','otherval4');
